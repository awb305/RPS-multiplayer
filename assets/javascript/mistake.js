    ...
    $("body")
      .on("click", "#player-button", function(event) {
        ...
        database.ref().on("value", function(snapshot) {
          ...
          if (database.ref()) {
            players.one.playerName = $(".player-input")
              .val()
              .trim();
            console.log("playerName:", players.one.playerName);
            ...
            var playerName = $("<h3>");
            playerName.text(
              "Ready  " + players.one.playerName + "? You're Player One"
            );
            ...
            playerName.text(players.one.playerName);
